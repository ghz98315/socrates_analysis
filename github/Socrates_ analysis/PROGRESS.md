...
> 最后更新: 2026-03-02 (v1.6.19 复习列表缓存优化)
...
- ✅ 创建 `lib/stores/review-store.ts` 复习数据缓存
- ✅ 5分钟缓存机制（sessionStorage）
- ✅ shouldRefetch() 方法判断是否需要重新获取
...
#### ✅ v1.6.17-18 成就统计修复 + 工作台优化

**1. 成就统计计算修复**
- ✅ 过滤无效 achievement_id 并去重
- ✅ 重新计算总 XP 基于实际解锁成就
- ✅ 清理无效记录和重复记录
...
**1. Prompt三层架构优化**
- ✅ Layer 1 通用层：5 Whys根因分析法、MVP Hint原则
- ✅ Layer 2 科目层：变式训练三原则、难度递增
