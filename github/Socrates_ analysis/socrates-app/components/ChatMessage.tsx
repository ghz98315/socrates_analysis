  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        isUser
          ? "bg-gradient-to-br from-warm-500 to-warm-600 text-white rounded-br-md"
        ...
        <p className={cn(
          "text-[10px] mt-2",
          isUser ? "text-warm-100" : "text-muted-foreground"
        )}>
    ...
    <div className="space-y-4">
      {messages.length === 0 ? (
        <div className="text-center py-12">
          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-warm-100 to-warm-200 dark:from-warm-900/30 dark:to-warm-800/30 flex items-center justify-center">
            <Bot className="w-8 h-8 text-warm-500" />
          </div>
      ...
      {isLoading && (
        <div className="flex gap-3 items-end">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-warm-400 to-warm-500 flex items-center justify-center flex-shrink-0 shadow-sm">
            <Sparkles className="w-5 h-5 text-white" />
          </div>
